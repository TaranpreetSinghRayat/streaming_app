...
CREATE TABLE `settings` (
  ...
  `type` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT '1' COMMENT '1=input|2=img|3=textarea',
...
(5, 'mail.host', 'mail.tweekersnut.in', 'SMTP mail host', '1', 1),
(6, 'mail.username', 'hosting@tweekersnut.in', 'SMTP mail username', '1', 1),
(7, 'mail.password', 'mElf(69y?N-j', 'SMTP mail password', '1', 1),
(8, 'mail.enc', 'ssl', 'SMTP encryption', '1', 1),
(9, 'mail.port', '465', 'SMTP port', '1', 1),
(10, 'admin.email', 'hosting@tweekersnut.in', 'Admin email', '1', 1),
(11, 'app.logo', 'images/logo-1.png', 'application logo', '2', 1),
(12, 'contact.email', 'admin@tweekersnut.com', 'contact email', '1', 1),
