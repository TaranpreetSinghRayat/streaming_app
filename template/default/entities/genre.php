...
<section class="gen-section-padding-3">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="row">
                    <?php foreach ($gen_entities as $entity): ?>
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="gen-carousel-movies-style-1 movie-grid style-1">
                                <div class="gen-movie-contain">
                                    <div class="gen-movie-img">
                                        <img src="<?= BASE_URL . $entity['background'] ?>" alt="video-image">
                                        ...
                                        <div class="gen-movie-action">
                                            <a href="<?= BASE_URL ?>entitie.php?title=<?= $entity['id'] ?>" class="gen-button">
                                    ...
                                    <div class="gen-info-contain">
                                        <div class="gen-movie-info">
                                            <h3><a href="<?= BASE_URL ?>entitie.php?title=<?= $entity['id'] ?>"><?= $entity['name'] ?></a></h3>
                                        </div>
                                        <div class="gen-movie-meta-holder">
                                            <ul>
                                                <li> <i class="fab fa-imdb fa-2x"></i> <b><?= $entity['IMDB'] ?></b></li>
                                                <li>
                                                    <?php
                                                    $genres = json_decode($entity['genre'],true);
