                            ...
                            <div class="gen-carousel-movies-style-1 movie-grid style-1">
                                <div class="gen-movie-contain">
                                    <div class="gen-movie-img">
                                        <img src="<?= BASE_URL . $movie['background'] ?>" alt="video-image">
                                        ...
                                        <div class="gen-movie-action">
                                            <a href="<?= BASE_URL ?>entitie.php?title=<?= $movie['id'] ?>" class="gen-button">
                                    ...
                                    <div class="gen-info-contain">
                                        <div class="gen-movie-info">
                                            <h3><a href="<?= BASE_URL ?>entitie.php?title=<?= $movie['id'] ?>"><?= $movie['name'] ?></a></h3>
                                        </div>
                                        <div class="gen-movie-meta-holder">
                                            <ul>
                                                <li> <i class="fab fa-imdb fa-2x"></i> <b><?= $movie['IMDB'] ?></b></li>
                                                <li>
                                                    <?php
